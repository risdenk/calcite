 ...
 */
public class Elasticsearch6Schema extends AbstractSchema
  ...
  /**
   * Creates an Elasticsearch6 schema.
   *
   ...
   */
  Elasticsearch6Schema(Map<String, Integer> coordinates,
  ...
  @Override protected Map<String, Table> getTableMap() {
    ...
    try {
      ...
      for (ObjectObjectCursor<String, MappingMetaData> c : mapping) {
        builder.put(c.key, new Elasticsearch6Table(client, index, c.key));
      }
