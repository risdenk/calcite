...
/**
 * Factory that creates an {@link Elasticsearch6Schema}.
 *
 * <p>Allows a custom schema to be included in a model.json file.
 */
@SuppressWarnings("UnusedDeclaration")
public class Elasticsearch6SchemaFactory implements SchemaFactory {

  public Elasticsearch6SchemaFactory() {
  }
  ...
  @Override public Schema create(SchemaPlus parentSchema, String name,
    ...
    try {
      ...
      return new Elasticsearch6Schema(coordinates, userConfig, index);
    } catch (IOException e) {
...
// End Elasticsearch6SchemaFactory.java
