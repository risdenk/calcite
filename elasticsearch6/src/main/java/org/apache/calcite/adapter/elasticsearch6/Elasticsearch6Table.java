 ...
 */
package org.apache.calcite.adapter.elasticsearch6;
...
/**
 * Table based on an Elasticsearch6 type.
 */
public class Elasticsearch6Table extends AbstractElasticsearchTable {
  private final Client client;

  /**
   * Creates an Elasticsearch6Table.
   */
  public Elasticsearch6Table(Client client, String indexName, String typeName) {
  ...
  @Override protected Enumerable<Object> find(String index, List<String> ops,
    ...
    final Function1<SearchHit, Object> getter = Elasticsearch6Enumerator.getter(fields);
    ...
    return new AbstractEnumerable<Object>() {
      public Enumerator<Object> enumerator() {
        ...
        return new Elasticsearch6Enumerator(cursor, getter);
      }
    };
  }
}

// End Elasticsearch6Table.java
